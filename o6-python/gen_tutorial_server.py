...
The runnable source of truth is ``examples/advanced_applications/tutorial_server/`` -- ``server.py``
...
SOURCE_DIR = REPO_ROOT / "examples" / "advanced_applications" / "tutorial_server"
